...
@XmlType(name = "")
@XmlRootElement(name = "AbstractDummyResponse")
public class AbstractDummyResponse
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
     ...
     * 
     */
    public AbstractDummyResponse(final String string, final AbstractComplexObject _abstract, final List<AbstractComplexObject> abstracts) {
